...
(`intercom.panels`, опознание в `pjsip.conf` менеджера), телефон — с loopback,
куда его пускает удержание `api/connect` (`stream.py`, служба «asterisk»
реестра `services.py`): снаружи — каналом менеджера под сессией жильца, внутри
дома — локальной дверью без учётки, как весь локальный контур (решение
заказчика 2026-09-20). Своей учётки у телефона нет.
